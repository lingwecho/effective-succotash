<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"F:\phpStudy\PHPTutorial\WWW\kill\public/../application/admin\view\test\edit.html";i:1523418054;s:75:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\layout\default.html";i:1523111344;s:72:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\meta.html";i:1523111344;s:74:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\script.html";i:1523111344;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input checked="" id="c-switch" name="row[switch]" type="hidden" value="0"><label for="row[switch]-switch" class="control-label"><input id="row[switch]-switch" name="row[switch]" type="checkbox" <?php if(in_array(($row['switch']), explode(',',"1"))): ?>checked<?php endif; ?> value="1"> <?php echo __('Yes'); ?></label>
        </div>
    </div>
    <div class="form-group">
