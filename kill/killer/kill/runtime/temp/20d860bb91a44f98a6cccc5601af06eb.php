<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"F:\phpStudy\PHPTutorial\WWW\kill\public/../application/admin\view\test\add.html";i:1523435952;s:75:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\layout\default.html";i:1523111344;s:72:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\meta.html";i:1523111344;s:74:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\script.html";i:1523111344;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-refreshtime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[refreshtime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input checked="" id="c-switch" name="row[switch]" type="hidden" value="0"><label for="row[switch]-switch" class="control-label"><input id="row[switch]-switch" name="row[switch]" type="checkbox" value="1"> <?php echo __('Yes'); ?></label>
        </div>
    </div>
    <div class="form-group">
