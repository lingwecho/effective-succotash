<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"F:\phpStudy\PHPTutorial\WWW\kill\public/../application/admin\view\activity\add.html";i:1523522336;s:75:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\layout\default.html";i:1523111344;s:72:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\meta.html";i:1523111344;s:74:"F:\phpStudy\PHPTutorial\WWW\kill\application\admin\view\common\script.html";i:1523111344;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cafecube_id" data-rule="required" data-source="cafecube/index" class="form-control selectpage" name="row[cafecube_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-play_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Play_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-play_id" data-rule="required" data-source="play/index" class="form-control selectpage" name="row[play_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
